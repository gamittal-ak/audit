...
class AkamaiClient:
    ...
    async def get_traffic(self, switch_key: str, cpcodes: List[str], days: int = 15) -> dict:
        ...
        if resp.status_code == 429:
            logger.warning(
                "Reporting API 429 rate limit for switch_key=%s — traffic skipped for this call.",
                switch_key,
            )
            return {"data": []}
